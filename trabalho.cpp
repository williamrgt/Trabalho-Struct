...
alunos do cadastro. gerar relatório contendo quantidade alunos do sexo masculino
reprovados
...
int pesquisa(int pcod)
{
    for(int i = 0; i < 99; i++)
    {
        if(cadastro[i].codigo == pcod)
            //não existe aluno cadastrado com este código
            return 1;
     }
...
int pesquisaaltera(int pcod)
{
    /*funcao para buscar a posicão que esta o aluno
      cadastrado*/
    for(int i = 0; i < 99; i++)
    {
        if(cadastro[i].codigo == pcod)
